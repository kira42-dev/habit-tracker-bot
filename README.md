...
Баги, которые надо фиксить:
- Иногда напоминания не срабатывают после перезапуска бота, нужно разобраться с job_queue
- При большом количестве активностей клавиатура становится неюзабельной
